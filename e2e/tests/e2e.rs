...
#[test_case("stable-4.6", "amd64", "application/json")]
#[test_case("stable-4.6", "amd64", "application/vnd.redhat.cincinnati.v1+json")]
#[test_case("stable-4.6", "s390x", "*/*")]
#[test_case("stable-4.7", "amd64", "*/*")]
#[test_case("stable-4.7", "s390x", "application/vnd.redhat.cincinnati.v1+json")]
#[test_case("stable-4.8", "amd64", "application/vnd.redhat.cincinnati.v1+json")]
#[test_case("stable-4.8", "s390x", "application/json")]
#[test_case("stable-4.9", "amd64", "*/*")]
#[test_case("stable-4.9", "s390x", "application/vnd.redhat.cincinnati.v1+json")]
#[test_case("stable-4.7", "amd64", "application/vnd.redhat.cincinnati.v2+json")]
#[test_case("stable-4.7", "s390x", "application/vnd.redhat.cincinnati.v2+json")]
#[test_case("stable-4.8", "amd64", "application/vnd.redhat.cincinnati.v2+json")]
#[test_case("stable-4.8", "s390x", "application/vnd.redhat.cincinnati.v2+json")]
fn e2e_channel_success(channel: &'static str, arch: &'static str, header: &'static str) {
    let version = match header {
        "application/vnd.redhat.cincinnati.v2+json" => "v2",
        _ => "v1",
    };
